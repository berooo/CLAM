...
parser.add_argument('--source', default='/data/shibaorong/data/kidney/svs/KIRC',type=str,
...
parser.add_argument('--save_dir',default='/data/shibaorong/data/kidney/results/KIRC', type=str,
